...
const Snail = () => (
  <>
    <div className="snail-container bottom-1/4 left-0">
      <div className="snail-wrapper snail-left">
        <SnailIcon className="h-8 w-8 text-pink-400" />
      </div>
    </div>
    <div className="snail-container bottom-1/2 left-0">
      <div className="snail-wrapper snail-left">
        <SnailIcon className="h-12 w-12 text-purple-400" />
      </div>
    </div>
    <div className="snail-container snail-container-right bottom-1/3 right-0">
