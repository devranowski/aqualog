  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: 'ghost' }), 'w-full p-0 font-normal aria-selected:opacity-100'),
        day_range_start: 'day-range-start',
        day_range_end: 'day-range-end',
        day_selected:
          'w-full bg-neutral-900 text-neutral-50 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-neutral-900 focus:text-neutral-50 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-900 focus:text-neutral-50',
        day_today:
          '[&:not([aria-selected])]:bg-neutral-100 [&:not([aria-selected])]:text-neutral-500 hover:text-neutral-900 dark:bg-neutral-800 dark:[&:not([aria-selected])]:text-neutral-400 dark:hover:text-neutral-50',
        day_outside:
